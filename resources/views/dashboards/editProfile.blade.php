...
{{--  <div class="container w-[300px] md:w-[600px] m-auto p-5">
        ...
        <div class=" my-5">
            <form method="POST" action="/updateProfile" enctype="multipart/form-data">
                ...
                <input name="photo"
                    class="block w-full p-2 text-sm cursor-pointer text-gray-400 focus:outline-none  border-gray-600 placeholder-gray-400 rounded-xl"
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input name="fname" type="text" id="first_name"
                    class=" border border-gray-200   text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    "
